...
@Getter @Setter @Entity @Table(name = "mst_category")
public class MstCategory extends Auditable {
    ...
    @Column(name = "parent_id", columnDefinition = "uuid") private UUID parentId;
